...
const getBook = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateBook = (id, userId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const book = yield book_model_1.Book.findOne({ _id: id }).populate(
      'createdUser',
    );
    if (!book) {
      throw new apiError_1.default(
    ...
    const createdUserId =
      (_a = book.createdUser) === null || _a === void 0
        ? void 0
        : _a._id.toString();
...
const deleteBook = (id, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createdUserId =
      (_b = book.createdUser) === null || _b === void 0
        ? void 0
        : _b._id.toString();
    if (createdUserId !== userId) {
      throw new apiError_1.default(
